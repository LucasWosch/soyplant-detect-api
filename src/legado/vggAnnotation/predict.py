...
import os
print(os.path.exists('/src/legado/vggAnnotation/soja_detector_model.keras'))

IMG_SIZE = 224
model = models.load_model("/src/legado/vggAnnotation/soja_detector_model.keras", compile=False)
